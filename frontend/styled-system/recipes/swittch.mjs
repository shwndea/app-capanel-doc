...
const swittchSlotNames = [
	...
	['thumb', 'switch__thumb'],
	['indicator', 'switch__indicator'],
]
const swittchSlotFns = /* @__PURE__ */ swittchSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			swittchDefaultVariants,
			getSlotCompoundVariant(swittchCompoundVariants, slotName),
		),
	],
)
...
const swittchFn = memo((props = {}) => {
	return Object.fromEntries(
		swittchSlotFns.map(([slotName, slotFn]) => [
			slotName,
...
const swittchVariantKeys = ['variant', 'size']
