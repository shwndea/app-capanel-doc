...
const dataListSlotFns = /* @__PURE__ */ dataListSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			dataListDefaultVariants,
			getSlotCompoundVariant(dataListCompoundVariants, slotName),
		),
	],
)
...
const dataListFn = memo((props = {}) => {
	return Object.fromEntries(
		dataListSlotFns.map(([slotName, slotFn]) => [
			slotName,
...
const dataListVariantKeys = ['orientation', 'size', 'variant']
