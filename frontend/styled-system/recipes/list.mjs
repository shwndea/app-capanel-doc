...
const listSlotFns = /* @__PURE__ */ listSlotNames.map(([slotName, slotKey]) => [
	slotName,
	createRecipe(
		slotKey,
		listDefaultVariants,
		getSlotCompoundVariant(listCompoundVariants, slotName),
	),
])

const listFn = memo((props = {}) => {
	return Object.fromEntries(
		listSlotFns.map(([slotName, slotFn]) => [slotName, slotFn.recipeFn(props)]),
	)
})

const listVariantKeys = ['variant', 'align']
