...
const colorPickerSlotNames = [
	...
	['channelSliderLabel', 'colorPicker__channelSliderLabel'],
	['channelSliderTrack', 'colorPicker__channelSliderTrack'],
	['channelSliderThumb', 'colorPicker__channelSliderThumb'],
	['channelSliderValueText', 'colorPicker__channelSliderValueText'],
	...
	['channelText', 'colorPicker__channelText'],
]
const colorPickerSlotFns = /* @__PURE__ */ colorPickerSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			colorPickerDefaultVariants,
			getSlotCompoundVariant(colorPickerCompoundVariants, slotName),
		),
	],
)
...
const colorPickerFn = memo((props = {}) => {
	return Object.fromEntries(
		colorPickerSlotFns.map(([slotName, slotFn]) => [
			slotName,
...
const colorPickerVariantKeys = ['size', 'variant']
