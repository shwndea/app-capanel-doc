...
const emptyStateSlotFns = /* @__PURE__ */ emptyStateSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			emptyStateDefaultVariants,
			getSlotCompoundVariant(emptyStateCompoundVariants, slotName),
		),
	],
)
...
const emptyStateFn = memo((props = {}) => {
	return Object.fromEntries(
		emptyStateSlotFns.map(([slotName, slotFn]) => [
			slotName,
...
const emptyStateVariantKeys = ['size']
