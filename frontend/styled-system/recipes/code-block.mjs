...
const codeBlockSlotNames = [
	...
	['footer', 'code-block__footer'],
	['control', 'code-block__control'],
	['overlay', 'code-block__overlay'],
	['code', 'code-block__code'],
	['codeText', 'code-block__codeText'],
	['copyTrigger', 'code-block__copyTrigger'],
	['copyIndicator', 'code-block__copyIndicator'],
	['collapseTrigger', 'code-block__collapseTrigger'],
	['collapseIndicator', 'code-block__collapseIndicator'],
	['collapseText', 'code-block__collapseText'],
]
const codeBlockSlotFns = /* @__PURE__ */ codeBlockSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			codeBlockDefaultVariants,
			getSlotCompoundVariant(codeBlockCompoundVariants, slotName),
		),
	],
)
...
const codeBlockFn = memo((props = {}) => {
	return Object.fromEntries(
		codeBlockSlotFns.map(([slotName, slotFn]) => [
			slotName,
...
const codeBlockVariantKeys = ['size']
