...
const statusSlotFns = /* @__PURE__ */ statusSlotNames.map(
	([slotName, slotKey]) => [
		slotName,
		createRecipe(
			slotKey,
			statusDefaultVariants,
			getSlotCompoundVariant(statusCompoundVariants, slotName),
		),
	],
)
...
const statusFn = memo((props = {}) => {
	return Object.fromEntries(
		statusSlotFns.map(([slotName, slotFn]) => [
			slotName,
